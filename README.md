...
LeetCode深度优先搜索算法题的解题仓库
[LeetCode_DepthFirstSearch](https://github.com/Jason-Chen-Y/LeetCode_DepthFirstSearch/blob/master/README.md)
用于深度优先算法专项训练

[79. 单词搜索](https://leetcode.cn/problems/word-search/description/?envType=problem-list-v2&envId=depth-first-search) : [L79_exit](L79_exist)

[94. 二叉树的中序遍历](https://leetcode.cn/problems/binary-tree-inorder-traversal/?envType=problem-list-v2&envId=depth-first-search) : [L94_inorderTraversal](L94_inorderTraversal)
...
[508. 出现次数最多的子树元素和](https://leetcode.cn/problems/most-frequent-subtree-sum/description/?envType=problem-list-v2&envId=depth-first-search) : [L508_findFrequentTreeSum](L508_findFrequentTreeSum)

[513. 找树左下角的值](https://leetcode.cn/problems/find-bottom-left-tree-value/description/?envType=problem-list-v2&envId=depth-first-search) : [L513_findBottomLeftValue](L513_findBottomLeftValue)